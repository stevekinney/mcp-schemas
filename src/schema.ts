/**
 * @fileoverview This file defines the Model Context Protocol (MCP) schema, which is a JSON-RPC 2.0-based protocol for communication between clients and servers.
 * @remarks
 * This file was pulled from the official specification and represents the 2025-03-26 version of the protocol.
 * @see {@link https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/schema/2025-03-26/schema.ts}
 */
